      ...
      <div className="mb-[1.25em] flex flex-col gap-[0.75em]">
        <div className="flex flex-col gap-[0.375em]">
          ...
          <input
            ...
            className="w-full rounded-[0.5em] border-[0.0625em] border-solid border-solid-100 bg-white px-[0.75em] py-[0.5em] text-[1em] font-normal text-solid-900 shadow-[0px_0.0625em_0.1875em_0px_rgba(13,13,18,0.05),0px_0.0625em_0.125em_0px_rgba(13,13,18,0.04)] placeholder:text-solid-400"
            {...register("email")}
          />
