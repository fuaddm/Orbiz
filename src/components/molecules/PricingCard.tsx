  ...
  return (
    <div className="w-full rounded-3xl border border-solid border-solid-100 bg-white p-6 shadow-[0px_5px_10px_-2px_rgba(13,13,18,0.04),0px_4px_8px_-1px_rgba(13,13,18,0.02)] md:p-8">
      ...
      <div className="mb-2">
        ...
        <span className="text-base font-normal text-solid-500">{priceText}</span>
      </div>
      <div className="mb-6 text-base font-normal text-solid-500 md:mb-8">{text}</div>
      {children}
        ...
        {includes?.map((item) => {
          return (
            ...
            >
              ...
              <span className="text-base font-normal text-solid-500">{item}</span>
            </div>
          );
        })}
      </div>
