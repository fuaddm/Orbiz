...
const Button: FC<ButtonProps> = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  { variant = "primary", disabled = false, loading = false, loadingSize = 24, classNames = "", children, ...props },
  ref
) {
